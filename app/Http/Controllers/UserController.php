    ...
    public function login(Request $request)
    {
        ...
        public function profilesetup(Request $request)
        {
            ...
            if ($request->hasFile('profilepic')) 
            {
                ...
                $file->move(public_path('uploads/users/profilepics'), $profilepic_name);
                ...
                $data = [
                    ...
                    'active'  => 1,
                    'profile_image' => 'uploads/users/profilepics/'.$profilepic_name,
        ...
        public function changecoverimage(Request $request)
        {
            ...
            if ($request->hasFile('coverimage')) 
            {
                ...
                $file->move(public_path('uploads/users/coverimages'), $coverimage_name);
    
                
                $data = [
                
                    'cover_image' => 'uploads/users/coverimages/'.$coverimage_name,
                ];
